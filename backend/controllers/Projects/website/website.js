...
const createWebsiteProject = async (req, res) => {
    const { user, name, project_title, role, website_type, brand, preferred_stack, project_description, project_category } = req.body;
    ...
    try {
        const obj = {
            user, name, project_title, role, team_members: [], project_category, website_type, brand: brand !== null ? brand : {}, preferred_stack, project_description,
