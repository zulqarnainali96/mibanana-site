...
export default function TransitionsModal({ message, statuss }) {
        ...
        <div>
            ...
            >
                <Fade in={open}
                    ...
                    <ModalContent statuss={statuss} sx={style}>
...
const ModalContent = styled('div')(
    ...
    background-color: ${theme.palette.mode === 'dark' ? grey[900] :
            statuss === 'success' ? '#ccffcc' :
                statuss === 'error' ? '#ffcccc' :
                statuss === 'warning' ? '#ffffcc' :
                    '#fff'};                              
    border-radius: 8px;
