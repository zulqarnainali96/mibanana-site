...
function NewProjectsTable({
    ...
    return (
         ...
         */}
            <Table {...getTableProps()}>
                <MDBox component="thead" bgColor={mibananaColor.headerColor} sx={{ lineHeight: '25px' }} borderBottom="1px solid brown">
                    {headerGroups.map((headerGroup, key) => (
                        <TableRow key={key} sx={{ borderBottom: `1px solid ${mibananaColor.borderColor}` }} {...headerGroup.getHeaderGroupProps()}>
